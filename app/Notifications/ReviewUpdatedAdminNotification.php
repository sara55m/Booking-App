...
class ReviewUpdatedAdminNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        return FilamentNotification::make()
            ->title(__('messages.review_requires_remoderation'))
            ->body(__('messages.review_updated_admin_notification', [

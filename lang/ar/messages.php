...
return [
    ...
    'تم إلغاء حجزك بنجاح. ووفقًا لسياسة الإلغاء الخاصة بالعقار، فإن هذا الحجز غير قابل للاسترداد.',

    'payment_retained' =>
    'لم يتم إصدار أي مبلغ مسترد، وتم الاحتفاظ بالمبلغ المدفوع وفقًا لسياسة الإلغاء الخاصة بالعقار.',
    ],
    ...
    'ai' => [
        'trip_planner_default'=>'وجدنا بعض الفنادق المناسبة لرحلتك، لكن تعذر إنشاء برنامج الرحلة في الوقت الحالي.',

        'default_recommendation' => 'إليك أفضل أماكن الإقامة المطابقة لبحثك.',

        'no_matching_properties' => 'عذرًا، لم نعثر على أي أماكن إقامة تطابق طلبك. يمكنك تجربة تعديل بعض معايير البحث مثل السعر أو المرافق أو الوجهة أو تواريخ الإقامة.',

        'no_trip_plan_found' => 'لم يتم العثور على خطة رحلة لهذه المحادثة.',

        'no_generated_trip_plan_found' => 'لم يتم العثور على خطة رحلة تم إنشاؤها.',

        'trip_plan_saved_successfully' => 'تم حفظ خطة الرحلة بنجاح.',
